...
class COCOConditionalDataset(Dataset):
    def __init__(
        ...
        self.json_data = json.load(open(f"{self.data_prefix_path}/annotations/instances_{self._mode}.json",'r'))
...
def get_dataloader(cfg: Dict, testing_enable: bool = False) -> Tuple[DataLoader, DataLoader]:
